                            ...
                            <div className="card-body p-3">
                                ...
                                <div className="d-flex align-items-center gap-3 mb-3">
                                    ...
                                    >
                                        {getUrlForSlot(slot) ? (
                                            <img
                                                src={getUrlForSlot(slot)!}
                                                alt={slot}
                                                style={{ width:'100%', height:'100%',
                                                         objectFit: slot === 'bg' ? 'contain' : 'contain' }}
                                            />
                                        ) : (
                                ...
                                <div className="d-flex gap-2">
                                    <button
                                        className={`btn btn-sm flex-grow-1 ${
                                            activeSlot === slot ? 'btn-primary' : 'btn-outline-primary'
                                        }`}
                        ...
                        <div className="card-body p-4">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center"
                                        ...
                                        <div className="d-flex flex-column align-items-center"
                                            ...
                                            {leftUrl ? (
                                                ...
                                                <div className="rounded-2 border d-flex align-items-center
                                                                justify-content-center text-muted"
                                                     style={{ width:'60px', height:'60px',
                                                              borderStyle:'dashed', fontSize:'10px',
                                                              textAlign:'center' }}>
                                                    <span>Image<br/>gauche</span>
                                                </div>
                                            )}
                                            {leftLbl && (
                                                <small style={{ fontSize:'8px', color:'#666',
                            ...
                            <div className="row g-2 mt-2">
                                {[
                                    ...
                                    { label:'Image droite',  ok: !!rightUrl, color:'primary' },
                                    { label:'Background',    ok: !!bgUrl,    color:'primary' },
                                ].map(({ label, ok, color }) => (
                            ...
                            {/* Bouton save */}
                            <button
                                className={`btn w-100 mt-3 ${saved ? 'btn-success' : 'btn-primary'}`}
                                onClick={handleSave}
                            >
                                {saved
