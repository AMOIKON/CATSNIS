            ...
            <Modal.Body className="px-4">
                <div className="row g-4">
                    <div className="col-lg-5">
                        <p className="text-muted small mb-3">Choisissez les images pour cette impression.</p>
                            ...
                            <div key={slot} className="card border-0 shadow-sm rounded-3 mb-3">
                                <div className="card-body p-3">
                                    <div className="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        {getUrl(slot) && (
                                            <button className="btn btn-sm btn-outline-danger ms-auto py-0 px-2"
                                                    onClick={() => setUrl(slot, null)} style={{ fontSize: '11px' }}>
                                                <i className="bi bi-x-lg" />
                                            </button>
                                        )}
                                    </div>
                                    <div className="d-flex align-items-center gap-3">
                                        <div className="rounded-2 border d-flex align-items-center justify-content-center bg-light flex-shrink-0"
                                    ...
                                    {activeSlot === slot && (
                                        <div className="mt-2 pt-2 border-top">
                                            {loadingImgs ? (
                                                ...
                                                <p className="text-muted small text-center mb-0">Aucune image dans CATUSNIS</p>
                                            ) : (
                                                <div className="d-flex flex-wrap gap-1" style={{ maxHeight: '120px', overflowY: 'auto' }}>
                                                    {apiImages.map(img => (
                                                        <div key={img.id}
                                                            ...
                                                            <span style={{ fontSize: '8px', color: '#666', overflow: 'hidden',
                        ...
                        <button className={`btn btn-sm w-100 ${savedDefault ? 'btn-success' : 'btn-outline-secondary'}`}
                    ...
                    <div className="col-lg-7">
                        ...
                        <div className="rounded-3 border p-3"
                             style={{ background: '#f8f9fa', position: 'relative', overflow: 'hidden', minHeight: '180px' }}>
                            {bgUrl && (
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                <div className="d-flex justify-content-between align-items-center"
                                     style={{ borderBottom: '2px solid #0d6efd', paddingBottom: '10px', marginBottom: '10px' }}>
                                    <div className="d-flex flex-column align-items-center" style={{ width: '72px' }}>
                                        {leftUrl ? (
                                            <img src={leftUrl} alt="g" style={{ width: '55px', height: '55px', objectFit: 'contain' }} />
                                        ) : (
                                            <div className="d-flex flex-column align-items-center justify-content-center rounded-2 border text-muted"
                                                 style={{ width: '55px', height: '55px', borderStyle: 'dashed', fontSize: '9px', textAlign: 'center' }}>
                                    ...
                                    <div className="d-flex flex-column align-items-center" style={{ width: '72px' }}>
                                        {rightUrl ? (
                                            <img src={rightUrl} alt="d" style={{ width: '55px', height: '55px', objectFit: 'contain' }} />
                                        ) : (
                                            <div className="d-flex flex-column align-items-center justify-content-center rounded-2 border text-muted"
                                                 style={{ width: '55px', height: '55px', borderStyle: 'dashed', fontSize: '9px', textAlign: 'center' }}>
                                ...
                                <div className="d-flex justify-content-between mt-2 pt-1" style={{ borderTop: '1px solid #dee2e6' }}>
                        ...
                        <div className="row g-2 mt-2">
                            {(['left', 'right', 'bg'] as ImageSlot[]).map(slot => (
                                <div key={slot} className="col-4">
                                    <div className={`text-center p-2 rounded-3 small ${getUrl(slot) ? 'bg-success bg-opacity-10 text-success' : 'bg-light text-muted'}`}
                                         style={{ fontSize: '11px' }}>
