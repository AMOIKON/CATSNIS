...
export const ALL_MENUS: NavMenu[] = [
  ...
  // ✅ Documentation — visible par tous les rôles authentifiés
  {
    ...
    children:[
      { key:'manual-user', label:'Manuel utilisateur',  path:'/manuals', icon:'bi-person-lines-fill'      },
      { key:'manual-proc', label:'Manuel de procédure', path:'/manuals', icon:'bi-file-earmark-text-fill' },
    ],
  },
];
